...
import com.eason.sell.dao.ProductCategoryRepository;
...
public class CategoryServiceImplTest {
    ...
    @Test
    public void save() {
        ProductCategory productCategory = new ProductCategory("男生店铺",15);
        ProductCategory resutl = categoryService.save(productCategory);
